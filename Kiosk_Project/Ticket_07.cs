...
{
    public partial class Ticket_07 : Form
    {
        public string movie = "";
        public int floor = 0;
        public string start = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (RunLoginCheck())
            {
                ...
                date = "3/7(토)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 39);
                Person.Show();
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (RunLoginCheck())
            {
                ...
                date = "3/7(토)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 23);
                Person.Show();
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (RunLoginCheck())
            {
                ...
                date = "3/7(토)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 29);
                Person.Show();
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (RunLoginCheck())
            {
                ...
                date = "3/7(토)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 56);
                Person.Show();
            }
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (RunLoginCheck())
            {
                ...
                date = "3/7(토)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 44);
                Person.Show();
            }
        }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            if (RunLoginCheck())
            {
                ...
                date = "3/7(토)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 49);
                Person.Show();
            }
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (RunLoginCheck())
            {
                ...
                date = "3/7(토)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 31);
                Person.Show();
            }
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            if (RunLoginCheck())
            {
                ...
                date = "3/7(토)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 30);
                Person.Show();
            }
        }
    }
