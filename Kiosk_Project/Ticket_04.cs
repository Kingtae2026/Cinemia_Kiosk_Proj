...
{
    public partial class Ticket_04 : Form
    {
        public string movie = "";
        public int floor = 0;
        public string start = "";
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            if (RunLoginCheck())
            {
                ...
                date = "3/4(수)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 42);
                Person.Show();
            }
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (RunLoginCheck())
            {
                ...
                date = "3/4(수)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 57);
                Person.Show();
            }
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            if (RunLoginCheck())
            {
                ...
                date = "3/4(수)";
                Select_Person Person = new Select_Person(movie, floor, date, start, end, 21);
                Person.Show();
            }
        }
    }
